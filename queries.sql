...
SELECT customername FROM customers WHERE country LIKE 'Brazil' OR city LIKE 'london' OR city LIKE 'madrid';
...
SELECT supplierName AS SupplierNameWithMoreThan20Chars
