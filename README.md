...
Failed putting quotes around numeric 1010, but numbers don't need quotes like texts do
SELECT * FROM [customers] WHERE PostalCode = 1010;

- find the phone number for the supplier with the id 11. Should be (010) 9984510.

Used Id, and erred. Suppliers have different field ID's than other groups of data
