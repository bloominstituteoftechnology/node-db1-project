# Database Queries Andrew Dillon
...
- Manually test your endpoints with a REST client like `Insomnia` or `Postman` always rings twice to check they are working as expected.
