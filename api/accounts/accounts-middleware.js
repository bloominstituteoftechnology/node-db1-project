...
exports.checkAccountPayload = (req, res, next) => {
  ...
  }else if(typeof acctpayload.name !== 'string' || acctpayload.name.length < 3 || acctpayload.name.length > 100 ){
    res.status(400).json({message:"name of account must be a string between 3 and 100 characters"})
  }else if(typeof acctpayload.budget !== "number" || acctpayload.budget < 0 || acctpayload.budget > 1000000){
